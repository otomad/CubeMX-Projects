...
#define LCD_DIR                DISPLAY_DIR_R    // 默认显示方向
...
#define LCD_RST_Set	HAL_GPIO_WritePin(GPIOH,GPIO_PIN_4,GPIO_PIN_SET) 
#define LCD_RST_Clr	HAL_GPIO_WritePin(GPIOH,GPIO_PIN_4,GPIO_PIN_RESET)
